...
import pandas as pd
from analysis.plots.mom_pup.maternal_proximity_bout_duration import plot_duration

matplotlib.use("Agg")

from analysis.plots.mom_pup.maternal_proximity_bout_duration import DEFAULT_STEM

def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Plot mean duration of body-scale maternal proximity bouts "
