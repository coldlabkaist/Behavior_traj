...
METRIC = "n_body_scale_proximity_bouts"

DEFAULT_STEM = "maternal_proximity_bout_count_1s"
...
def plot_bout_count(
    ...
    ax.set_ylabel("Proximity bout count", fontsize=20, labelpad=12)
    duration_label = (
        "all bouts"
    ...
    ax.set_title(
        f"Maternal proximity bouts ({duration_label})",
        fontsize=26,
        pad=16,
    )
